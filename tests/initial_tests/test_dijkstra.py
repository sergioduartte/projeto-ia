...
def test_dijkstra_direct_path_vs_two_alternatives():
    ...
    graph.add_edge("B", "G", weight=5)
    graph.add_edge("G", "H", weight=35)
...
def test_dijkstra_bottleneck_path_ignored():
    ...
    graph.add_edge("S", "G", weight=8)
    graph.add_edge("G", "H", weight=10)
